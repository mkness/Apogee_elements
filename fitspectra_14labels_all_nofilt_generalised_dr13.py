...
normed_training_data = 'normed_data_19_filt_dr13.pickle'
...
if __name__ == "__main__":
    ...
    if self_flag < 1:
      ...
      for each in bl: 
        ...
        testmetaall, inv_covars = infer_labels_nonlinear("coeffs_2nd_order_14_cal_nofilt_dr13.pickle", testdataall, ids, field+"tags_14_nofilt_dr13.pickle",0.00,1.40) 
    ...
    if self_flag == 2:
      ...
      file_in.close() 
      testmetaall, inv_covars = infer_labels_nonlinear("coeffs_2nd_order_14_cal_nofilt_dr13.pickle", testdataall, ids, field+"tags_14_nofilt.pickle",-10.950,10.99) 
    if self_flag == 3:
      leave_one_star_out()
    if self_flag == 4:
      pixlist = loadtxt("pixtest4.txt", usecols = (0,), unpack =1) 
